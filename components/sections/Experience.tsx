...
const experiences = [
  {
    ...
    description: [
      ...
      "Participated in testing and refactoring the e-learning platform software",
  ...
  },
  {
    ...
    description: [
      "Worked as a Penetration Tester, responsible for identifying and addressing security vulnerabilities in computer systems and networks",
      "Utilized Kali Linux and other tools to conduct penetration testing and vulnerability assessments, ensuring the security of the organization's infrastructure",
      "Collaborated with cross-functional teams to develop and implement remediation strategies to enhance the overall security posture",
    ],
  },
  {
    title: "Penetration Tester",
    ...
    description: [
      "Gained practical experience in various aspects of cyber security, including network security, ethical hacking, and vulnerability assessment",
      "Assisted in conducting penetration testing and identifying potential security vulnerabilities within the system",
      "Contributed to the development and implementation of security measures to protect against cyber threats, utilizing tools such as Kali Linux and SQL injection techniques using BurpSuite",
    ],
  },
  {
    title: "Frontend Developer",
